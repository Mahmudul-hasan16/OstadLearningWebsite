            ...
            <div className="flex flex-col justify-center max-w-md p-6  sm:px-12  dark:text-gray-100">
                ...
                <div className="space-y-4 text-center divide-y divide-gray-700">
                    <div className="my-2 space-y-1">
                        <h2 className="text-xl font-semibold sm:text-2xl">Md.Mahmudul Hasan</h2>
                        <p className="px-5 text-xs sm:text-base dark:text-gray-400 border">Web developer</p>
                    ...
                    <div className="flex justify-center pt-2 space-x-4 align-center">
                        <a rel="noopener noreferrer" href="https://github.com/Mahmudul-hasan16" aria-label="GitHub" className="p-2 rounded-md dark:text-gray-100 hover:dark:text-violet-400">
